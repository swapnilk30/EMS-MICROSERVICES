...
public class EmployeeController {
	...
	public ResponseEntity<ApiResponse<EmployeeDto>> createEmployee(@Valid @RequestBody EmployeeDto employeeDto) {
		...
		ApiResponse<EmployeeDto> apiResponse = ApiResponse.success("Employee created successfully", response);
	...
	public ResponseEntity<ApiResponse<List<EmployeeDto>>> getAllEmployees() {
		...
		return ResponseEntity.status(HttpStatus.OK)
				.body(ApiResponse.success("Employees fetched successfully", responses));
	...
	public ResponseEntity<ApiResponse<EmployeeDetailsDto>> getEmployeeDetails(@PathVariable Long id) {

		EmployeeDetailsDto response = employeeService.getEmployeeDetails(id);

		return ResponseEntity.ok(ApiResponse.success("Employee details fetched successfully", response));
	}
	...
	public ApiResponse<String> hello() {
		...
		return new ApiResponse<>(true, "Auth Service is running", "Hello from Employee Service");
	}
